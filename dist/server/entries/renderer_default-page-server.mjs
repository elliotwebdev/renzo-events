...
async function render(pageContext) {
  ...
  const title = documentProps && documentProps.title || "Renzo Events | Houston, TX";
  ...
  const ogImageUrl = "https://opengraph.b-cdn.net/production/images/0e35e86a-4641-437a-bda5-1cc4613dd7ff.png?token=xuUs2EVs1lXbIvknsPospgASSk5QpL6zcrWLDd1uP5Y&height=630&width=1200&expires=33268856223";
  const documentHtml = escapeInject`<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
        <link rel="icon" type="image/png" href="${ogImageUrl}" />
        <link rel="apple-touch-icon" sizes="180x180" href="${ogImageUrl}">
        <link rel="icon" type="image/png" href="${ogImageUrl}" sizes="32x32">
