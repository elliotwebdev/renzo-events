...
const academies = {
  ...
  "Houston (HQ)": {
    ...
    "BJJ": [
      {
        // Monday
        start: new Date(2023, 4, 1, 6, 30),
        end: new Date(2023, 4, 1, 7, 30)
      },
      {
      ...
      {
        // Wednesday
        start: new Date(2023, 4, 3, 6, 30),
        end: new Date(2023, 4, 3, 7, 30)
      },
      {
        // Thursday
    ...
    "No-Gi BJJ": [
      ...
      {
        //Friday
        start: new Date(2023, 4, 5, 6, 30),
        end: new Date(2023, 4, 5, 7, 30)
      },
      {
    ...
    "Adults Muay Thai": [
      ...
      {
        //Wednesday
        start: new Date(2023, 4, 3, 7, 30),
        end: new Date(2023, 4, 3, 8, 30),
        color: "#6e23fb"
      },
      {
        start: new Date(2023, 4, 3, 18, 30),
      ...
      {
        //Friday
        start: new Date(2023, 4, 5, 7, 30),
        end: new Date(2023, 4, 5, 8, 30),
        color: "#6e23fb"
      },
      {
        //Saturday
        start: new Date(2023, 4, 6, 6, 30),
    ...
    "Kids Muay Thai": [
      {
        //Monday
        start: new Date(2023, 4, 1, 16, 45),
        end: new Date(2023, 4, 1, 17, 30),
        color: "#6e23fb"
      },
      {
        //Tuesday
        start: new Date(2023, 4, 2, 16, 45),
        end: new Date(2023, 4, 2, 17, 30),
        color: "#6e23fb"
      },
      {
        //Wednesday
        start: new Date(2023, 4, 3, 16, 45),
        end: new Date(2023, 4, 3, 17, 30),
        color: "#6e23fb"
      },
      {
        //Thursday
        start: new Date(2023, 4, 4, 16, 45),
    ...
    "Situational / Live Training (7-11 y.o)": {
      //Saturday
    ...
    "OPEN MAT": {
      //Sunday
      start: new Date(2023, 4, 0, 10, 0),
      end: new Date(2023, 4, 0, 12, 0)
    }
  },
  "The Grove": {
    ...
    "BJJ": [
      ...
      {
        // Tuesday
        start: new Date(2023, 4, 2, 5, 0),
        end: new Date(2023, 4, 2, 6, 0)
      },
      {
    ...
    "No-Gi BJJ": [
      ...
      {
        //Thursday
        start: new Date(2023, 4, 4, 5, 0),
        end: new Date(2023, 4, 4, 6, 0)
      },
      {
  ...
  "HTX (Downtown)": {
    ...
    "No-Gi BJJ": [
      ...
      {
        //Thursday
        start: new Date(2023, 4, 4, 9, 0),
        end: new Date(2023, 4, 4, 10, 0)
      },
      {
        //Saturday
        start: new Date(2023, 4, 6, 11, 0),
    ...
    "Women's Kickboxing": [
      {
        ...
        end: new Date(2023, 4, 1, 9, 30),
        color: "#6e23fb"
      },
      {
        //Wednesday
        start: new Date(2023, 4, 3, 8, 30),
        end: new Date(2023, 4, 3, 9, 30),
        color: "#6e23fb"
      },
      {
        //Friday
        start: new Date(2023, 4, 5, 8, 30),
        end: new Date(2023, 4, 5, 9, 30),
        color: "#6e23fb"
      }
    ],
    "Little BJJ (4-7 y.o.)": [
...
function Footer() {
  return /* @__PURE__ */ jsx(Box, { mt: 2, pos: "relative", bottom: "0", py: 4, color: "blackAlpha", children: /* @__PURE__ */ jsx(Flex, { justifyContent: "center", children: /* @__PURE__ */ jsx(Text, { fontSize: ["12px", "16px"], as: "a", href: "https://elliotweb.dev", children: "Renzo Events © 2023" }) }) });
}
...
function Page() {
  ...
  function ButtonDisplay() {
    ...
    return /* @__PURE__ */ jsx(Button, { variant: "solid", ref: btnRef, sx: variant, colorScheme: "messenger", onClick: onOpen, children: /* @__PURE__ */ jsx(Heading, { size: isLg ? "2xl" : "lg", className: isLg ? "rotateText" : "", children: "SELECT SCHEDULE" }) });
  }
  ...
  return /* @__PURE__ */ jsxs(Box, { position: "relative", children: [
    ...
    /* @__PURE__ */ jsxs(Flex, { justifyContent: "center", alignItems: "center", mx: [null, null, null, 24, 24], children: [
      ...
      /* @__PURE__ */ jsxs(Box, { width: "100%", children: [
        calendarDisplay(),
        /* @__PURE__ */ jsx(Text, { color: "blackAlpha", mt: 1, fontSize: ["12px", "16px"], children: "Last Updated 9.25.23" })
      ] })
    ] }),
    /* @__PURE__ */ jsx(Footer, {})
  ] });
